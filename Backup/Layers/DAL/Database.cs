...
namespace DBLayers.DAL
{
    public class Database : IDisposable
    {
        ...
        {
            //string strConexao = @"Password=123321;Persist Security Info=True;User ID=sa;Initial Catalog=Bananas;Data Source=(Local)\SQLDATABASE";
            string strConexao = @"Password=123321;Persist Security Info=True;User ID=bananasbro1;Data Source=dbsq0009.whservidor.com";
            ...
            ref SqlTransaction trans)
        {
            ...
            try
            {
                ...
                //TODO: FAZER FUNFAR O RETURN VALUE
