...
{
    public partial class ColecaoListaProgramacao : Bananas.Administrativo.UserControl.UserControlBase
    {
        #region Propriedade
        ...
        {
            Response.Redirect(
                string.Concat("~/Administrativo/CadastroProgramacao.aspx?Codigo=", grdListaProgramacao.DataKeys[e.NewEditIndex].Value.ToString())
            );
        }
        #endregion
        #region Metodos
        ...
        {
            Response.Redirect("~/Administrativo/CadastroProgramacao.aspx");
        }
    }
