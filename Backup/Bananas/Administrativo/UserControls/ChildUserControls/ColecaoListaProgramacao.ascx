...
<legend>Programação</legend>
        ...
        <asp:GridView runat="server" ID="grdListaProgramacao" EmptyDataText="Nenhum registro encontrado." DataKeyNames="Codigo"
            AutoGenerateColumns="false" OnRowEditing="grdListaProgramacao_RowEditing">
            <Columns>
