...
{
    public partial class InstanciaCliente : Bananas.Administrativo.UserControl.UserControlBase,
        References.Web.Interfaces.IInstanciaUserControlBase
    {
        ...
        public DBLayers.DAL.Entidades.Cliente Instancia
        {
            get
            {
                ...
                int qtdecidadesalcance = 0;
                if(!int.TryParse(txtAlcance.Text, out qtdecidadesalcance))
                    instancia.QtdeCidadesAlcance = qtdecidadesalcance;
